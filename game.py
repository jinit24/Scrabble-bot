...
def print_tiles(stdscr, tiles, user):
    ...
    stdscr.addstr(Y_OFFSET, X_OFFSET + 7*X_STEP + 80, "]")
...
def user_move(stdscr, prefix_trie, board, new_char_pos, first_move, user, tiles):
    ...
    stdscr.addstr(Y_OFFSET + 6, X_OFFSET + 70, " "*50)
    ...
    if(x[0] == -1):
        ...
        stdscr.addstr(Y_OFFSET + 6, X_OFFSET + 70, x[1])
...
def main(stdscr):
    ...
    while True:
        ...
        if c == curses.KEY_UP:
            ...
            # stdscr.addstr(Y_OFFSET + 14, X_OFFSET + 93, 8*" ")
